function PlotComponentsBehaveBulk(caim,nums,save,mov,Belt,ref,timeint,horizontal)
...
if mov < length(C(1,:))       
hcap = annotation('textarrow',[xp1+.09,xp1+.09],[yp2+.01,yp2+.01],...
       'color',pltcol,...
       'HeadStyle','none',...
       'string','GC components',...
       'fontsize',ftsz,...
       'VerticalAlignment','bottom',...  
       'HorizontalAlignment','left'); 
end
